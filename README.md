 ...
 **WORKING FUNCTION**
 ...
 arduino IDE and then Run the python code and it will strat the webcam and take pictures , if the picture match with database upto 83% then it will send a charecter to the arduino and arduino will move the servo motor for 5 seconds.
